...
const expectedAliasFake string = `// This file was generated by counterfeiter
package fixturesfakes
...
func (fake *FakePotato) Tomato(arg1 git.Oid) {
...
func (fake *FakePotato) TomatoArgsForCall(i int) git.Oid {
	fake.tomatoMutex.RLock()
	defer fake.tomatoMutex.RUnlock()
