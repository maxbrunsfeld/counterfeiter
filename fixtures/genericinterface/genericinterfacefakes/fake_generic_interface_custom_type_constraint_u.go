...
func _[T genericinterface.CustomTypeConstraintU]() {
	var _ genericinterface.GenericInterfaceCustomTypeConstraintU[T] = new(FakeGenericInterfaceCustomTypeConstraintU[T])
}
