...
func (fake *FakeThing) DoCallCount() int {
	fake.doMutex.RLock()
	defer fake.doMutex.RUnlock()
	return len(fake.doArgsForCall)
}

func (fake *FakeThing) DoCalls(stub func(string) (int, error)) {
	fake.doMutex.Lock()
	defer fake.doMutex.Unlock()
	fake.DoStub = stub
}

func (fake *FakeThing) DoArgsForCall(i int) string {
	fake.doMutex.RLock()
	defer fake.doMutex.RUnlock()
...
func (fake *FakeThing) DoReturnsOnCall(i int, result1 int, result2 error) {
	fake.doMutex.Lock()
	defer fake.doMutex.Unlock()
	fake.DoStub = nil
...
func (fake *FakeThing) Invocations() map[string][][]interface{} {
...
var _ externaltest.Thing = new(FakeThing)
